...
- **SeisComP XML attachment** — optional, preferred origin with picks, magnitudes, and arrivals
...
- **Event retraction** — automatic cancellation emails when events are set to "not existing"
- **Per-event log files** — separate log per run (`mceqnotifier_<eventID>_<timestamp>.log`)
